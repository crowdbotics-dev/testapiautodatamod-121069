...
## Project Structure
    ...
    ├── testapiautodatamod_121069  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_121069`
...
2. Clone this repo and `cd testapiautodatamod_121069`
